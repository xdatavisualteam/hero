					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller">
							<ul class="gn-menu">
								...
								<li>
									<a href="#pricing" class="gn-icon gn-icon-download">Services</a>
								</li>
								<li>
									<a href="#team" class="gn-icon gn-icon-article">Developers</a>
								</li>
								<li>
									<a href="#features" class="gn-icon gn-icon-help">Features</a>
								</li>
								<li>
									<a href="#screenshots" class="gn-icon gn-icon-pictures">Portfolios</a>
								</li>
								<li>
					...
					<div class="row">
						<div class="col-lg-8 col-lg-offset-2">
							...
							<div class="section-heading">
								<h2>SERVICES</h2>
								<p>
									We deliver a full spectrum of development services to clients from more than 30 countries. Over 1300 + diverse IT professionals with strong technology skills and business knowledge and mature methodologies enable us to effectively handle software projects of any scale and complexity. 
								</p>
							</div>
		                ...
		                <div class="panel-body no-padding text-align-center">
							<div class="price-features">
								<ul class="list-unstyled text-left">
						          <li><i class="fa fa-check text-success"></i><strong> HTML5, CSS, JavaScript, Bootstrap, jQuery</strong></li>
						          <li><i class="fa fa-check text-success"></i><strong> AngularJS, ReactJS, d3.js, VueJS, BackboneJS, KnockoutJS, TypeScript</strong></li>
						          <li><i class="fa fa-check text-success"></i><strong> NodeJS, ExpressJS, Hapi, Sails</strong></li>
						          <li><i class="fa fa-check text-success"></i><strong> PHP, Laravel, CodeIgniter, Symphony, Yii, Drupal, CakePHP, Joomla, WordPress</strong></li>
						          <li><i class="fa fa-check text-success"></i><strong> Python, Django, Flask, Pyramid</strong></li>
						          <li><i class="fa fa-check text-success"></i><strong> Ruby, Ruby on Rails, Sinatra, CoffeeScript</strong></li>
						          <li><i class="fa fa-check text-success"></i><strong> .NET, ASP.NET, ASP.NET MVC, C#, Entity</strong></li>
						          <li><i class="fa fa-check text-success"></i><strong> MongoDB, MySQL, MSSQL, PostgreSQL</strong></li>
						        </ul>
							</div>
		                </div>
		            </div>
		        ...
		        <div class="col-xs-12 col-sm-6 col-md-4">
		            <div class="panel panel-primary pricing-big">
		                ...
		                <div class="panel-body no-padding text-align-center">
							<div class="price-features">
								<ul class="list-unstyled text-left">
						          <li><i class="fa fa-check text-success"></i><strong> Ionic Framework</strong></li>
						          <li><i class="fa fa-check text-success"></i><strong> React Native</strong></li>
						          <li><i class="fa fa-check text-success"></i><strong> Objective-C</strong></li>
						          <li><i class="fa fa-check text-success"></i><strong> Java, Android Studio</strong></li>
						          <li><i class="fa fa-check text-success"></i><strong> Xamarin</strong></li>
						          <li><i class="fa fa-check text-success"></i><strong> Apache Cordova</strong></li>
						          <li><i class="fa fa-check text-success"></i><strong> PhoneGap</strong></li>
						          <li><i class="fa fa-check text-success"></i><strong> Titanium</strong></li>
						          <li><i class="fa fa-check text-success"></i><strong> Meteor</strong></li>
						        </ul>
							</div>
		                </div>
		            </div>
		        ...
		        <div class="col-xs-12 col-sm-6 col-md-4">
		            <div class="panel panel-info pricing-big">
		                ...
		                <div class="panel-body no-padding text-align-center">
							<div class="price-features">
								<ul class="list-unstyled text-left">
						          <li><i class="fa fa-check text-success"></i><strong> Shopify, Shopify template</strong></li>
						          <li><i class="fa fa-check text-success"></i><strong> Magento</strong></li>
						          <li><i class="fa fa-check text-success"></i><strong> Webflow</strong></li>
						          <li><i class="fa fa-check text-success"></i><strong> WooCommerce</strong></li>
						          <li><i class="fa fa-check text-success"></i><strong> BigCommerce</strong></li>
						          <li><i class="fa fa-check text-success"></i><strong> PretaShop</strong></li>
						          <li><i class="fa fa-check text-success"></i><strong> OpenCart</strong></li>
						          <li><i class="fa fa-check text-success"></i><strong> SEO</strong></li>
						        </ul>
							</div>
		                </div>
		            </div>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-8 col-lg-offset-2">
							...
							<div class="section-heading">
								<h2>DiazSoft Developers</h2>
								<p>
									We are all over the world. We are talent developers.
								</p>
							</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-8 col-lg-offset-2">
							...
							<div class="section-heading">
								<h2>The Features of DiazSoft</h2>
								<p>
									Trusted global software development company with more than 10 years of professional experience.
								</p>
							</div>
					...
					<div class="row">
						<div class="col-lg-8 col-lg-offset-2">
							...
							<div class="section-heading">
								<h2>Portfolios</h2>
								<p>
									We create amazing and beautiful websites, mobile apps, etc.
								</p>
							</div>
				...
				<div class="row">
					<div class="col-sm-12 col-md-12 col-lg-12" >
						...
						<div class="row gallery-item">
							<div class="col-md-3">
								<a href="img/works/1.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/1.jpg"> <img src="img/works/1.jpg" class="img-responsive" alt="img"> </a>
							</div>
							<div class="col-md-3">
							...
							<div class="col-md-3">
								<a href="img/works/4.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/4.jpg"> <img src="img/works/4.jpg" class="img-responsive" alt="img"> </a>
							</div>
							<div class="col-md-3">
					...
					<div class="row">
						<div class="col-lg-8 col-lg-offset-2">
							...
							<div class="section-heading">
								<h2>Get in touch</h2>
								<p>
									If you are looking for talent and reliable developers, then please don't hesitate to contact us
								</p>
							</div>
